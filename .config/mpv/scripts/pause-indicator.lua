...
settings['pause-indicator-foreground-style'] = [[\\blur0\\shad0\\c&HC8C8C7&\\4c&H7776DD&\\alpha&H77]]
helpText['pause-indicator-foreground-style'] = [[A string of ASS override tags that get applied only to the foreground of the
pause indicator.
]]
settings['pause-indicator-background-style'] = [[\\blur0\\bord0\\c&0c0c0c&\\4c&0c0c0c&\\alpha&H99]]
...
settings['animation-duration'] = 0.26
